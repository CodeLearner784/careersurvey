    ...
    elements: [
     {
      type: "checkbox",
      name: "question6",
      title: "How did you acquire your knowledge and skills to transit to IT industry?",
      isRequired: true,
      hasOther: true,
      choices: [
       {
    ...
    elements: [
     {
      type: "radiogroup",
      name: "question3",
      title: "How important would you rate your past work experience in facilitating your transition to IT industry",
      isRequired: true,
      choices: [
       {
        value: "NotImportant",
    ...
    elements: [
     {
      type: "multipletext",
      name: "question4",
      title: "How would you rank the importance of the following skills in your transition to IT industry? Rank ordered from 1 (lowest) to 3 (highest).",
      isRequired: true,
      items: [
       {
        name: "learning skills",
        inputType: "number",
        title: "learning skills (creativity and innovation, critical thinking and problem solving, presentation etc)",
        maxLength: 3,
        validators: [
         {
          type: "numeric",
       ...
       },
       {
        name: "life skills",
        inputType: "number",
        title: "life skills (social, motivation, flexibility and adaptability, initiative and self-direction etc)",
        maxLength: 2,
        validators: [
         {
          type: "numeric",
    ...
    elements: [
     {
      type: "multipletext",
      name: "question8",
      title: "How would you rank the importance of the following key attributes in your transition to IT industry? Rank ordered from 1 (lowest) to 3 (highest).",
      isRequired: true,
      items: [
       {
    ...
    elements: [
     {
      type: "radiogroup",
      name: "question11",
      title: "What you feel is the biggest challenge in changing career to IT industry",
      isRequired: true,
      hasOther: true,
      choices: [
       {
    ...
    elements: [
     {
      type: "checkbox",
      name: "question13",
      title: "What are the main obstacles/barriers you encountered in securing a job in IT industry?",
      isRequired: true,
      hasOther: true,
      choices: [
       "Ageism",
    ...
    elements: [
     {
      type: "checkbox",
      name: "question10",
      title: "If you are planning to get education/training to learn needed skills which kind of training/education would you prefer or have already taken?",
      isRequired: true,
      hasOther: true,
      choices: [
       {
    ...
    elements: [
     {
      type: "radiogroup",
      name: "question15",
      title: "Was there supports from government or companies when you made mid-career transition?",
      isRequired: true,
      choices: [
       "Yes",
       "No"
    ...
    elements: [
     {
      type: "radiogroup",
      name: "question12",
      title: "Do you think it would be easier to get a job after a mid-career transition?",
      isRequired: true,
      choices: [
       "Yes",
       "No"
